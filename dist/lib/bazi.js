...
import { ChildLimit, DefaultEightCharProvider, LunarHour, LunarSect2EightCharProvider, } from 'tyme4ts';
const eightCharProvider1 = new DefaultEightCharProvider();
const eightCharProvider2 = new LunarSect2EightCharProvider();
export const buildHideHeavenObject = (heavenStem, me) => {
    if (!heavenStem) {
        return undefined;
    }
    return {
 ...
 */
export const buildSixtyCycleObject = (sixtyCycle, me) => {
...
const buildGodsObject = (eightChar, gender) => {
...
const buildDecadeFortuneObject = (solarTime, gender, me) => {
