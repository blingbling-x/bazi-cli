...
This skill teaches you how to use the `bazi` command-line tool to provide Chinese Bazi (八字) fortune-telling calculations. The tool is already installed in this project — just run the commands directly.
